...
public class WebDAVXMLGenerator extends XMLNamespacePrefixManager
{
	...
	*/
	...
	{
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_RESPONSE));	//create a response element
	}
	...
	*/
	public Element addHref(final Element element, final URI uri) throws DOMException
	{
		...
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_HREF), uri.toString());
	}
	...
	*/
	public Element addPropstat(final Element element) throws DOMException
	{
		...
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_PROPSTAT));
	}
	...
	*/
	...
	{			
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_PROP));	//create a prop element and append it to the given element
	}
	...
	*/
	public Element addPropertyName(final Element propElement, final WebDAVPropertyName propertyName) throws DOMException
	{
		final String propertyNamespace=propertyName.getNamespace();	//get the property namespace
			//create a property element and append it to the given prop element
		return appendElement(propElement, propertyNamespace, createQualifiedName(getNamespacePrefix(propertyNamespace), propertyName.getLocalName()));
	}
	...
	*/
	...
	{			
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_REMOVE));	//create a remove element and append it to the given element
	}
	...
	*/
	...
	{			
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_SET));	//create a set element and append it to the given element
	}
	...
	*/
	public Element addStatus(final Element element, final String status) throws DOMException
	{
		...
		return appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), ELEMENT_STATUS), status);
	}
	...
	*/
	public Element addResourceType(final Element element, final String typeNamespace, final String typeLocalName) throws DOMException
	{
		...
		final Element resourceTypeElement=appendElement(element, WEBDAV_NAMESPACE, createQualifiedName(getNamespacePrefix(WEBDAV_NAMESPACE), RESOURCE_TYPE_PROPERTY_NAME));
		if(typeNamespace!=null && typeLocalName!=null)	//if a type was given
		{
			appendElement(resourceTypeElement, typeNamespace, createQualifiedName(getNamespacePrefix(typeNamespace), typeLocalName));	//look up the prefix and create a subelement to represent the resource type
		}
