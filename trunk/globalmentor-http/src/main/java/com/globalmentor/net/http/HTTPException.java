...
public class HTTPException extends IOException {
	...
	/**
	 * Translates the given resource I/O exception to an HTTP-specific exception. The following special translations are performed:
	 * <dl>
	 * <dt>{@link ResourceForbiddenException}</dt>
	 * <dd>{@link HTTPForbiddenException}</dd>
	 * <dt>{@link ResourceNotFoundException}</dt>
	 * <dd>{@link HTTPNotFoundException}</dd>
	 * <dt>{@link ResourceStateException}</dt>
